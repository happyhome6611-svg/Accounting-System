...
<div class="alert alert-info">Upload → Map Fields → Validate → Preview → Confirm → Entity Created. Creation uses the same transactional domain service as the manual workflow.</div>
