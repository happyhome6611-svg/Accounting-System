...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/companies/{company}/banking/accounts', [BankingController::class, 'accounts'])->name('banking.accounts');
    Route::post('/companies/{company}/banking/accounts', [BankingController::class, 'storeAccount'])->name('banking.accounts.store');
    Route::put('/companies/{company}/banking/accounts/{account}', [BankingController::class, 'updateAccount'])->name('banking.accounts.update');
    Route::patch('/companies/{company}/banking/accounts/{account}/status', [BankingController::class, 'status'])->name('banking.accounts.status');
    Route::delete('/companies/{company}/banking/accounts/{account}', [BankingController::class, 'destroy'])->name('banking.accounts.destroy');
    Route::get('/companies/{company}/banking/accounts/{account}/register', [BankingController::class, 'register'])->name('banking.register');
    Route::get('/companies/{company}/banking/transactions/create', [BankingController::class, 'createTransaction'])->name('banking.transactions.create');
    Route::post('/companies/{company}/banking/transactions', [BankingController::class, 'storeTransaction'])->name('banking.transactions.store');
    Route::get('/companies/{company}/banking/accounts/{account}/imports', [BankingController::class, 'imports'])->name('banking.imports');
    Route::post('/companies/{company}/banking/accounts/{account}/imports/preview', [BankingController::class, 'preview'])->name('banking.imports.preview');
    Route::post('/companies/{company}/banking/accounts/{account}/imports', [BankingController::class, 'confirmImport'])->name('banking.imports.confirm');
    Route::get('/companies/{company}/banking/accounts/{account}/matching', [BankingController::class, 'matching'])->name('banking.matching');
    Route::post('/companies/{company}/banking/accounts/{account}/matching/{row}', [BankingController::class, 'match'])->name('banking.match');
    Route::post('/companies/{company}/banking/accounts/{account}/matching/{row}/create', [BankingController::class, 'createFromStatement'])->name('banking.match.create');
    Route::get('/companies/{company}/banking/accounts/{account}/reconciliations', [BankingController::class, 'reconciliations'])->name('banking.reconciliations');
    Route::post('/companies/{company}/banking/accounts/{account}/reconciliations', [BankingController::class, 'storeReconciliation'])->name('banking.reconciliations.store');
    Route::post('/companies/{company}/banking/reconciliations/{reconciliation}/complete', [BankingController::class, 'completeReconciliation'])->name('banking.reconciliations.complete');
